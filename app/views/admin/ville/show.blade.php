...
{{-- Page title --}}
@section('title') Consulter une ville - {{$ville->Ref . '/ ' . $ville->Nom}} @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Ville :  {{$ville->Ref . '/ ' . $ville->Nom}}</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Consultation des informations de la ville
                </div>
                <!-- /.panel-heading -->
                        ...
                        <div class="col-lg-12">
                            ...
                            {{ Form::model($ville, array('route' => array('admin.ville.update', $ville->VilleID), 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal')) }}
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <p class="form-control-static">{{$ville->Ref}}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Nom</label>
                                    <div class="col-lg-9">
                                        <p class="form-control-static">{{$ville->Nom}}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Pays</label>
                                    <div class="col-lg-9">
                                        <p class="form-control-static">{{($ville->Pays) ? $ville->Pays->Ref . ' ' . $ville->Pays->Nom : ""}}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Description</label>
                                    <div class="col-lg-9">
                                        <p class="form-control-static">{{$ville->Description}}</p>
                                    </div>
                                </div>
