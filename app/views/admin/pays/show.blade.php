...
{{-- Page title --}}
@section('title') Consulter un pays - {{$pays->Ref . '/ ' . $pays->Nom}} @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Pays :  {{$pays->Ref . '/ ' . $pays->Nom}}</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Consultation des informations du pays
                </div>
                <!-- /.panel-heading -->
                        ...
                        <div class="col-lg-12">
                            ...
                            {{ Form::model($pays, array('route' => array('admin.pays.update', $pays->PaysID), 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal')) }}
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <p class="form-control-static">{{$pays->Ref}}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Nom</label>
                                    <div class="col-lg-9">
                                        <p class="form-control-static">{{$pays->Nom}}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Description</label>
                                    <div class="col-lg-9">
                                        <p class="form-control-static">{{$pays->Description}}</p>
                                    </div>
                                </div>
