...
{{-- Page title --}}
@section('title') Modifier un pays @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Mise-à-jour des informations du pays </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if ( $errors->count() > 0 )
                                ...
                                @endforeach
                            @endif
                            {{ Form::model($pays, array('route' => array('admin.pays.update', $pays->PaysID), 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal')) }}
                                <div class="form-group @if($errors->first('Ref') != '') has-error @endif">
                                    <label class="col-lg-3 control-label">Référence *</label>
                                    <div class="col-lg-9">
                                        {{ Form::text('Ref', $pays->Ref, array('class' => 'form-control', 'placeholder' => "Référence", 'id' => 'Ref') ) }}
                                ...
                                <div class="form-group @if($errors->first('Nom') != '') has-error @endif">
                                    ...
                                    <div class="col-lg-9">
                                        {{ Form::text('Nom', $pays->Nom, array('class' => 'form-control', 'placeholder' => "Nom", 'id' => 'Nom') ) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        {{ Form::textarea('Description', $pays->Description, array('class' => 'form-control') ) }}
                                    </div>
                                </div>
